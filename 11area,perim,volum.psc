...
def calcular_area_volumen_y_perimetro():
    # Solicitar la longitud del lado de la base cuadrada
    lado = float(input("Introduce la longitud del lado de la base cuadrada: "))
    ...
    # Mostrar resultados
    print(f"El área de la base del prisma cuadrado es: {area_base}")
    print(f"El área lateral del prisma cuadrado es: {area_lateral}")
    print(f"El área total del prisma cuadrado es: {area_total}")
    print(f"El volumen del prisma cuadrado es: {volumen}")
    print(f"El perímetro de la base del prisma cuadrado es: {perimetro_base}")
